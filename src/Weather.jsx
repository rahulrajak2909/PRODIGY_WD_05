...
import cleanImage from "../src/Assest/Clean.png";
import Haze from "../src/Assest/Haze.png";
import Rainy from "../src/Assest/Rainy.jpeg";
...
const Weather = () => {
  ...
  return (
    <div className='weatherbox'>
      ...
      {report && (
        <div>
          <div className='city' style={{ color: 'white' }} >{report.name}</div>
          ...
          <div style={{ marginLeft: "100px", width: "220px", marginTop: "20px", fontSize: '45px', color: "white" }}> {currentLocalTime}</div>
        </div>
      )}
    </div>
  );
